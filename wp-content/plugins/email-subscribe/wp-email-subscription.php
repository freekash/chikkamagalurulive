...
function email_subscription_popup_load_styles_and_js(){
   ...
   wp_register_style( 'wp-email-subscription-popup', plugins_url('/css/wp-email-subscription-popup.css', __FILE__),array(),'1.2.9' );
   wp_register_script('wp-email-subscription-popup-js',plugins_url('/js/wp-email-subscription-popup-js.js', __FILE__),array(),'1.2.9');
   wp_register_script('subscribe-popup',plugins_url('/js/subscribe-popup.js', __FILE__),array(),'1.2.9');
   wp_register_style('subscribe-popup',plugins_url('/css/subscribe-popup.css', __FILE__),array(),'1.2.9');
